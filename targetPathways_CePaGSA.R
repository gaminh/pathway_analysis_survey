...
load("/Users/GaMinh/Dropbox/WSU/Papers/PathwayReview/alldatasetsCePaGSA_ver3.RData")
...
load("/Users/GaMinh/Dropbox/WSU/Papers/PathwayReview/CePaGSA_corrected.RData")

rankWithNull <- rep(NA, 35)
pvalueWithNull <- rep(NA, 35)

for(i in 1:length(Renal_cell_carcinoma)) {
  rankWithNull[Renal_cell_carcinoma[i]] <- myCePaGSAComb_Corrected["hsa05211",36+Renal_cell_carcinoma[i]]
  pvalueWithNull[Renal_cell_carcinoma[i]] <- myCePaGSAComb_Corrected["hsa05211",1+Renal_cell_carcinoma[i]]
}

for(i in 1:length(Alzheimers_disease)) {
  rankWithNull[Alzheimers_disease[i]] <- myCePaGSAComb_Corrected["hsa05010",36+Alzheimers_disease[i]]
  pvalueWithNull[Alzheimers_disease[i]] <- myCePaGSAComb_Corrected["hsa05010",1+Alzheimers_disease[i]]
}


for(i in 1:length(Thyroid_cancer)) {
  
  rankWithNull[Thyroid_cancer[i]] <- myCePaGSAComb_Corrected["hsa05216",36+ Thyroid_cancer[i]]
  pvalueWithNull[Thyroid_cancer[i]] <- myCePaGSAComb_Corrected["hsa05216",1+Thyroid_cancer[i]]
}

for(i in 1:length(Colorectal_cancer)) {
  #myCePaGSAComb_Corrected <- myData[[Colorectal_cancer[i]]]
  rankWithNull[Colorectal_cancer[i]] <- myCePaGSAComb_Corrected["hsa05210",36+Colorectal_cancer[i]]
  pvalueWithNull[Colorectal_cancer[i]] <- myCePaGSAComb_Corrected["hsa05210",1+Colorectal_cancer[i]]
}

for(i in 1:length(Prostate_cancer)) {
  #myCePaGSAComb_Corrected <- myData[[Prostate_cancer[i]]]
  rankWithNull[Prostate_cancer[i]] <- myCePaGSAComb_Corrected["hsa05215",36+Prostate_cancer[i]]
  pvalueWithNull[Prostate_cancer[i]] <- myCePaGSAComb_Corrected["hsa05215",1+Prostate_cancer[i]]
}

for(i in 1:length(Acute_myeloid_leukemia)) {
  #myCePaGSAComb_Corrected <- myData[[Acute_myeloid_leukemia[i]]]
  rankWithNull[Acute_myeloid_leukemia[i]] <- myCePaGSAComb_Corrected["hsa05221",Acute_myeloid_leukemia[i]+36]
  pvalueWithNull[Acute_myeloid_leukemia[i]] <- myCePaGSAComb_Corrected["hsa05221",1+Acute_myeloid_leukemia[i]]
}

for(i in 1:length(Pancreatic_cancer)) {
  
  rankWithNull[Pancreatic_cancer[i]] <- myCePaGSAComb_Corrected["hsa05212",36+Pancreatic_cancer[i]]
  pvalueWithNull[Pancreatic_cancer[i]] <- myCePaGSAComb_Corrected["hsa05212",1+Pancreatic_cancer[i]]
}

for(i in 1:length(Non_small_cell_lung_cancer)) {
  
  rankWithNull[Non_small_cell_lung_cancer[i]] <- myCePaGSAComb_Corrected["hsa05223",36+Non_small_cell_lung_cancer[i]]
  pvalueWithNull[Non_small_cell_lung_cancer[i]] <- myCePaGSAComb_Corrected["hsa05223",1+Non_small_cell_lung_cancer[i]]
}

for(i in 1:length(Glioma)) {
  rankWithNull[Glioma[i]] <- myCePaGSAComb_Corrected["hsa05214",36+Glioma[i]]
  pvalueWithNull[Glioma[i]] <- myCePaGSAComb_Corrected["hsa05214",1+Glioma[i]]
}

for(i in 1:length(Parkinsons_disease)) {
  rankWithNull[Parkinsons_disease[i]] <- myCePaGSAComb_Corrected["hsa05012",36+Parkinsons_disease[i]]
  pvalueWithNull[Parkinsons_disease[i]] <- myCePaGSAComb_Corrected["hsa05012",1+Parkinsons_disease[i]]
}

for(i in 1:length(Chronic_myeloid_leukemia)) {
  rankWithNull[Chronic_myeloid_leukemia[i]] <- myCePaGSAComb_Corrected["hsa05220",36+Chronic_myeloid_leukemia[i]]
  pvalueWithNull[Chronic_myeloid_leukemia[i]] <- myCePaGSAComb_Corrected["hsa05220",1+Chronic_myeloid_leukemia[i]]
}

for(i in 1:length(Type_II_diabetes_mellitus)) {
  rankWithNull[Type_II_diabetes_mellitus[i]] <- myCePaGSAComb_Corrected["hsa04930",36+Type_II_diabetes_mellitus[i]]
  pvalueWithNull[Type_II_diabetes_mellitus[i]] <- myCePaGSAComb_Corrected["hsa04930",1+Type_II_diabetes_mellitus[i]]
}


for(i in 1:length(Dilated_cardiomyopathy)) {
  rankWithNull[Dilated_cardiomyopathy[i]] <- myCePaGSAComb_Corrected["hsa05414",36+Dilated_cardiomyopathy[i]]
  pvalueWithNull[Dilated_cardiomyopathy[i]] <- myCePaGSAComb_Corrected["hsa05414",1+Dilated_cardiomyopathy[i]]
}


for(i in 1:length(Huntingtons_disease)) {
  rankWithNull[Huntingtons_disease[i]] <- myCePaGSAComb_Corrected["hsa05016",36+Huntingtons_disease[i]]
  pvalueWithNull[Huntingtons_disease[i]] <- myCePaGSAComb_Corrected["hsa05016",1+Huntingtons_disease[i]]
}

for(i in 1:length(Endometrial_cancer)) {
  rankWithNull[Endometrial_cancer[i]] <- myCePaGSAComb_Corrected["hsa05213",36+Endometrial_cancer[i]]
  pvalueWithNull[Endometrial_cancer[i]] <- myCePaGSAComb_Corrected["hsa05213",1+Endometrial_cancer[i]]
}
...
save(rankWithoutNull, pvalueWithoutNull, rankWithNull, pvalueWithNull, file = "CePaGSATargetPW.RData")
...
files= c("alzheimerCePaGSA.RData", "AMLCePaGSA.RData")
...
save(rank, pvalue, file = "54Datasets_CePaGSA.RData")
...
load("/Users/GaMinh/Dropbox/WSU/Papers/PathwayReview/CePaGSA15vs15_400_2000.RData")

pw = rownames(resNullIA)
pw = gsub("path:","", pw)
resNullCePaGSA = resNullCePaGSA[intersect(pw,rownames(resNullCePaGSA)),]

bias0 = vector(mode="numeric", length=nrow(resNullCePaGSA))
bias1 = vector(mode="numeric", length=nrow(resNullCePaGSA))
names(bias0) = resNullCePaGSA$Name
names(bias1) = resNullCePaGSA$Name

for (i in 1:nrow(resNullCePaGSA)) {
  # print(i)
  x = resNullCePaGSA[i,-c(1:3)]
...
save(TargetPW,dataSets, rankBias0, rankWithNullBias0, rankBias1, rankWithNullBias1, rankWithoutNull, rankWithNull,pValueBias0, 
     pValueWithNullBias0,pValueBias1, pValueWithNullBias1,pvalueWithoutNull, pvalueWithNull, file = "CePaGSA_bias.RData")
...
load("CePaGSATargetPW.RData")
# save(dataSets, pvalueWithNull, pvalueWithoutNull, rankWithNull, rankWithoutNull, TargetPW, file = "CePaGSATargetPW.RData")
...
bias = vector(mode="numeric", length=nrow(resNullCePaGSA))
names(bias) = resNullCePaGSA$Name

for (i in 1:nrow(resNullCePaGSA)) {
  x = as.numeric(resNullCePaGSA[i,-c(1:3)])
  x =  na.omit(x)
  bias[i] = Pearson(x)
}
...
save(bias0List, bias1List, file = "CePaGSA_bias.RData")
...
boxplot(rankWithoutNull[Alzheimers_disease], rankWithNull[Alzheimers_disease],
        main="Rank(s) of Alzheimer's disease (CePaGSA)", 
...
boxplot(rankWithoutNull[Thyroid_cancer], rankWithNull[Thyroid_cancer],
        main="Rank(s) of Thyroid cancer (CePaGSA)", 
...
boxplot(rankWithoutNull[Dilated_cardiomyopathy], rankWithNull[Dilated_cardiomyopathy],
        main="Rank(s) of Dilated cardiomyopathy (CePaGSA)", 
...
boxplot(rankWithoutNull[Colorectal_cancer], rankWithNull[Colorectal_cancer],
        main="Rank(s) of Colorectal cancer (CePaGSA)", 
...
boxplot(rankWithoutNull[Prostate_cancer], rankWithNull[Prostate_cancer],
        main="Rank(s) of Prostate cancer (CePaGSA)", 
...
boxplot(rankWithoutNull[Huntingtons_disease], rankWithNull[Huntingtons_disease],
        main="Rank(s) of Huntington's disease (CePaGSA)", 
...
boxplot(rankWithoutNull[Acute_myeloid_leukemia], rankWithNull[Acute_myeloid_leukemia],
        main="Rank(s) of Acute myeloid leukemia (CePaGSA)", 
...
boxplot(rankWithoutNull[Pancreatic_cancer], rankWithNull[Pancreatic_cancer],
        main="Rank(s) of Pancreatic cancer (CePaGSA)", 
...
boxplot(rankWithoutNull[Non_small_cell_lung_cancer], rankWithNull[Non_small_cell_lung_cancer],
        main="Rank(s) of Non-small cell lung cancer (CePaGSA)", 
...
boxplot(rankWithoutNull[Parkinsons_disease], rankWithNull[Parkinsons_disease],
        main="Rank(s) of Parkinson's disease (CePaGSA)", 
...
boxplot(rankWithoutNull[Type_II_diabetes_mellitus], rankWithNull[Type_II_diabetes_mellitus],
        main="Rank(s) of Type II diabetes mellitus (CePaGSA)", 
...
boxplot(rankWithoutNull[Chronic_myeloid_leukemia], rankWithNull[Chronic_myeloid_leukemia],
        main="Rank(s) of Chronic myeloid leukemia (CePaGSA)", 
...
boxplot(rankWithoutNull[Endometrial_cancer], rankWithNull[Endometrial_cancer],
        main="Rank(s) of Endometrial cancer (CePaGSA)", 
...
boxplot(pvalueWithoutNull[Renal_cell_carcinoma], pvalueWithNull[Renal_cell_carcinoma],
        main="pValue(s) of Renal cell carcinoma (CePaGSA)", 
...
boxplot(pvalueWithoutNull[Alzheimers_disease], pvalueWithNull[Alzheimers_disease],
        main="pValue(s) of Alzheimer's disease (CePaGSA)", 
...
boxplot(pvalueWithoutNull[Thyroid_cancer], pvalueWithNull[Thyroid_cancer],
        main="pValue(s) of Thyroid cancer (CePaGSA)", 
...
boxplot(pvalueWithoutNull[Dilated_cardiomyopathy], pvalueWithNull[Dilated_cardiomyopathy],
        main="pValue(s) of Dilated cardiomyopathy (CePaGSA)", 
...
boxplot(pvalueWithoutNull[Colorectal_cancer], pvalueWithNull[Colorectal_cancer],
        main="pValue(s) of Colorectal cancer (CePaGSA)", 
...
boxplot(pvalueWithoutNull[Prostate_cancer], pvalueWithNull[Prostate_cancer],
        main="pValue(s) of Prostate cancer (CePaGSA)", 
...
boxplot(pvalueWithoutNull[Huntingtons_disease], pvalueWithNull[Huntingtons_disease],
        main="pValue(s) of Huntington's disease (CePaGSA)", 
...
boxplot(pvalueWithoutNull[Acute_myeloid_leukemia], pvalueWithNull[Acute_myeloid_leukemia],
        main="pValue(s) of Acute myeloid leukemia (CePaGSA)", 
...
boxplot(pvalueWithoutNull[Pancreatic_cancer], pvalueWithNull[Pancreatic_cancer],
        main="pValue(s) of Pancreatic cancer (CePaGSA)", 
...
boxplot(pvalueWithoutNull[Non_small_cell_lung_cancer], pvalueWithNull[Non_small_cell_lung_cancer],
        main="pValue(s) of Non-small cell lung cancer (CePaGSA)", 
...
boxplot(pvalueWithoutNull[Glioma], pvalueWithNull[Glioma],
        main="pValue(s) of Glioma (CePaGSA)", 
...
boxplot(pvalueWithoutNull[Parkinsons_disease], pvalueWithNull[Parkinsons_disease],
        main="pValue(s) of Parkinson's disease (CePaGSA)", 
...
boxplot(pvalueWithoutNull[Type_II_diabetes_mellitus], pvalueWithNull[Type_II_diabetes_mellitus],
        main="pValue(s) of Type II diabetes mellitus (CePaGSA)", 
...
boxplot(pvalueWithoutNull[Chronic_myeloid_leukemia], pvalueWithNull[Chronic_myeloid_leukemia],
        main="pValue(s) of Chronic myeloid leukemia (CePaGSA)", 
...
boxplot(pvalueWithoutNull[Endometrial_cancer], pvalueWithNull[Endometrial_cancer],
        main="pValue(s) of Endometrial cancer (CePaGSA)", 
...
boxplot(pvalueWithoutNull[Cancer], pvalueWithNull[Cancer],
        main="pValue(s) of Cancer (CePaGSA)", 
