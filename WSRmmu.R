...
# pdf(paste0("ROC_WRS_", dataset,"_", targetSymbol, "_",methodDE[j],".pdf"), width = 5, height = 5)
# plot(rocobj,legacy.axes=TRUE, main= "ROC curve of WSR", percent=TRUE, col="red", print.auc=T )
# dev.off()
# Confusion matrix:
...
save(temp, rocobj, TP, FP, FN, TN, sensitivity, accuracy, specificity,  
     file = paste0("wrs", dataset, "_",targetSymbol, "_", methodDE[j], ".RData"))
