...
#load("/Users/GaMinh/Dropbox/WSU/Papers/PathwayReview/alldatasetsWRS.RData")
load("/Users/GaMinh/Dropbox/WSU/Papers/PathwayReview/alldatasetsWRS.RData")
...
load("/Users/GaMinh/Dropbox/WSU/Papers/PathwayReview/WRS_corrected(3rd run).RData")
rankWithNull <- rep(NA, 35)
pvalueWithNull <- rep(NA, 35)

for(i in 1:length(Renal_cell_carcinoma)) {
  rankWithNull[Renal_cell_carcinoma[i]] <- myWRSComb_Corrected["Renal cell carcinoma",36+Renal_cell_carcinoma[i]]
  pvalueWithNull[Renal_cell_carcinoma[i]] <- myWRSComb_Corrected["Renal cell carcinoma",1+Renal_cell_carcinoma[i]]
}

for(i in 1:length(Alzheimers_disease)) {
  rankWithNull[Alzheimers_disease[i]] <- myWRSComb_Corrected["Alzheimer's disease",36+Alzheimers_disease[i]]
  pvalueWithNull[Alzheimers_disease[i]] <- myWRSComb_Corrected["Alzheimer's disease",1+Alzheimers_disease[i]]
}


for(i in 1:length(Thyroid_cancer)) {
  
  rankWithNull[Thyroid_cancer[i]] <- myWRSComb_Corrected["Thyroid cancer",36+ Thyroid_cancer[i]]
  pvalueWithNull[Thyroid_cancer[i]] <- myWRSComb_Corrected["Thyroid cancer",1+Thyroid_cancer[i]]
}

for(i in 1:length(Colorectal_cancer)) {
  #myWRSComb_Corrected <- myData[[Colorectal_cancer[i]]]
  rankWithNull[Colorectal_cancer[i]] <- myWRSComb_Corrected["Colorectal cancer",36+Colorectal_cancer[i]]
  pvalueWithNull[Colorectal_cancer[i]] <- myWRSComb_Corrected["Colorectal cancer",1+Colorectal_cancer[i]]
}

for(i in 1:length(Prostate_cancer)) {
  #myWRSComb_Corrected <- myData[[Prostate_cancer[i]]]
  rankWithNull[Prostate_cancer[i]] <- myWRSComb_Corrected["Prostate cancer",36+Prostate_cancer[i]]
  pvalueWithNull[Prostate_cancer[i]] <- myWRSComb_Corrected["Prostate cancer",1+Prostate_cancer[i]]
}

for(i in 1:length(Acute_myeloid_leukemia)) {
  #myWRSComb_Corrected <- myData[[Acute_myeloid_leukemia[i]]]
  rankWithNull[Acute_myeloid_leukemia[i]] <- myWRSComb_Corrected["Acute myeloid leukemia",36+Acute_myeloid_leukemia[i]]
  pvalueWithNull[Acute_myeloid_leukemia[i]] <- myWRSComb_Corrected["Acute myeloid leukemia",1+Acute_myeloid_leukemia[i]]
}

for(i in 1:length(Pancreatic_cancer)) {
  
  rankWithNull[Pancreatic_cancer[i]] <- myWRSComb_Corrected["Pancreatic cancer",36+Pancreatic_cancer[i]]
  pvalueWithNull[Pancreatic_cancer[i]] <- myWRSComb_Corrected["Pancreatic cancer",1+Pancreatic_cancer[i]]
}

for(i in 1:length(Non_small_cell_lung_cancer)) {
  
  rankWithNull[Non_small_cell_lung_cancer[i]] <- myWRSComb_Corrected["Non-small cell lung cancer",36+Non_small_cell_lung_cancer[i]]
  pvalueWithNull[Non_small_cell_lung_cancer[i]] <- myWRSComb_Corrected["Non-small cell lung cancer",1+Non_small_cell_lung_cancer[i]]
}

for(i in 1:length(Glioma)) {
  rankWithNull[Glioma[i]] <- myWRSComb_Corrected["Glioma",36+Glioma[i]]
  pvalueWithNull[Glioma[i]] <- myWRSComb_Corrected["Glioma",1+Glioma[i]]
}

for(i in 1:length(Parkinsons_disease)) {
  rankWithNull[Parkinsons_disease[i]] <- myWRSComb_Corrected["Parkinson's disease",36+Parkinsons_disease[i]]
  pvalueWithNull[Parkinsons_disease[i]] <- myWRSComb_Corrected["Parkinson's disease",1+Parkinsons_disease[i]]
}

for(i in 1:length(Chronic_myeloid_leukemia)) {
  rankWithNull[Chronic_myeloid_leukemia[i]] <- myWRSComb_Corrected["Chronic myeloid leukemia",36+Chronic_myeloid_leukemia[i]]
  pvalueWithNull[Chronic_myeloid_leukemia[i]] <- myWRSComb_Corrected["Chronic myeloid leukemia",1+Chronic_myeloid_leukemia[i]]
}

for(i in 1:length(Type_II_diabetes_mellitus)) {
  rankWithNull[Type_II_diabetes_mellitus[i]] <- myWRSComb_Corrected["Type II diabetes mellitus",36+Type_II_diabetes_mellitus[i]]
  pvalueWithNull[Type_II_diabetes_mellitus[i]] <- myWRSComb_Corrected["Type II diabetes mellitus",1+Type_II_diabetes_mellitus[i]]
}


for(i in 1:length(Dilated_cardiomyopathy)) {
  rankWithNull[Dilated_cardiomyopathy[i]] <- myWRSComb_Corrected["Dilated cardiomyopathy",36+Dilated_cardiomyopathy[i]]
  pvalueWithNull[Dilated_cardiomyopathy[i]] <- myWRSComb_Corrected["Dilated cardiomyopathy",1+Dilated_cardiomyopathy[i]]
}


for(i in 1:length(Huntingtons_disease)) {
  rankWithNull[Huntingtons_disease[i]] <- myWRSComb_Corrected["Huntington's disease",36+Huntingtons_disease[i]]
  pvalueWithNull[Huntingtons_disease[i]] <- myWRSComb_Corrected["Huntington's disease",1+Huntingtons_disease[i]]
}

for(i in 1:length(Endometrial_cancer)) {
  rankWithNull[Endometrial_cancer[i]] <- myWRSComb_Corrected["Endometrial cancer",36+Endometrial_cancer[i]]
  pvalueWithNull[Endometrial_cancer[i]] <- myWRSComb_Corrected["Endometrial cancer",1+Endometrial_cancer[i]]
}
...
save(TargetPW, dataSets, rankWithoutNull, pvalueWithoutNull, rankWithNull,pvalueWithNull, file=paste0(path,"WRSTargetPW.RData"))

######################   63 datasets ##############################################

path = "/Users/GaMinh/Dropbox/WSU/Papers/PathwayReview/"
setwd(path)
load("WRSTargetPW.RData")
rank = rankWithoutNull
pvalue = pvalueWithoutNull

files= c("alzheimerWRS.RData", "AMLWRS.RData", "InfluenzaWRS.RData")
...
save(rank, pvalue, file = "63Datasets_WRS.RData")
...
files= c("alzheimerWRS.RData", "AMLWRS.RData")
...
save(rank, pvalue, file = "54Datasets_WRS.RData")
...
title("WRS without DANUBE", ylab = "Rank of target pathways")
median(rankWithoutNull)

vioplot(pvalueWithoutNull, col = "grey", ylim = c(0,1))
title("WRS without DANUBE", ylab = "pValie of target pathways")
...
vioplot(pvalueWithNull, col = "grey", ylim = c(0,1))
...
save(TargetPW,dataSets, rankBias0, rankWithNullBias0, rankBias1, rankWithNullBias1, rankWithoutNull, rankWithNull,pValueBias0, 
     pValueWithNullBias0,pValueBias1, pValueWithNullBias1,pvalueWithoutNull, pvalueWithNull, file = "WRS_bias.RData")
...
bias = vector(mode="numeric", length=nrow(resNullWRS))
names(bias) = resNullWRS$Name

for (i in 1:nrow(resNullWRS)) {
  x = as.numeric(resNullWRS[i,-c(1:3)])
  x =  na.omit(x)
  bias[i] = Pearson(x)
}
...
save(bias0List, bias1List, file = "WRS_bias.RData")
...
boxplot(rankWithoutNull[Renal_cell_carcinoma], rankWithNull[Renal_cell_carcinoma],
        main="Rank(s) of Renal cell carcinoma (WRS)", 
...
boxplot(rankWithoutNull[Alzheimers_disease], rankWithNull[Alzheimers_disease],
        main="Rank(s) of Alzheimer's disease (WRS)", 
...
boxplot(rankWithoutNull[Thyroid_cancer], rankWithNull[Thyroid_cancer],
        main="Rank(s) of Thyroid cancer (WRS)", 
...
boxplot(rankWithoutNull[Dilated_cardiomyopathy], rankWithNull[Dilated_cardiomyopathy],
        main="Rank(s) of Dilated cardiomyopathy (WRS)", 
...
boxplot(rankWithoutNull[Colorectal_cancer], rankWithNull[Colorectal_cancer],
        main="Rank(s) of Colorectal cancer (WRS)", 
...
boxplot(rankWithoutNull[Prostate_cancer], rankWithNull[Prostate_cancer],
        main="Rank(s) of Prostate cancer (WRS)", 
...
boxplot(rankWithoutNull[Huntingtons_disease], rankWithNull[Huntingtons_disease],
        main="Rank(s) of Huntington's disease (WRS)", 
...
boxplot(rankWithoutNull[Acute_myeloid_leukemia], rankWithNull[Acute_myeloid_leukemia],
        main="Rank(s) of Acute myeloid leukemia (WRS)", 
...
boxplot(rankWithoutNull[Pancreatic_cancer], rankWithNull[Pancreatic_cancer],
        main="Rank(s) of Pancreatic cancer (WRS)", 
...
boxplot(rankWithoutNull[Non_small_cell_lung_cancer], rankWithNull[Non_small_cell_lung_cancer],
        main="Rank(s) of Non-small cell lung cancer (WRS)", 
...
boxplot(rankWithoutNull[Parkinsons_disease], rankWithNull[Parkinsons_disease],
        main="Rank(s) of Parkinson's disease (WRS)", 
...
boxplot(rankWithoutNull[Type_II_diabetes_mellitus], rankWithNull[Type_II_diabetes_mellitus],
        main="Rank(s) of Type II diabetes mellitus (WRS)", 
...
boxplot(rankWithoutNull[Chronic_myeloid_leukemia], rankWithNull[Chronic_myeloid_leukemia],
        main="Rank(s) of Chronic myeloid leukemia (WRS)", 
...
boxplot(rankWithoutNull[Endometrial_cancer], rankWithNull[Endometrial_cancer],
        main="Rank(s) of Endometrial cancer (WRS)", 
...
boxplot(pvalueWithoutNull[Renal_cell_carcinoma], pvalueWithNull[Renal_cell_carcinoma],
        main="pValue(s) of Renal cell carcinoma (WRS)", 
...
boxplot(pvalueWithoutNull[Alzheimers_disease], pvalueWithNull[Alzheimers_disease],
        main="pValue(s) of Alzheimer's disease (WRS)", 
...
boxplot(pvalueWithoutNull[Thyroid_cancer], pvalueWithNull[Thyroid_cancer],
        main="pValue(s) of Thyroid cancer (WRS)", 
...
boxplot(pvalueWithoutNull[Dilated_cardiomyopathy], pvalueWithNull[Dilated_cardiomyopathy],
        main="pValue(s) of Dilated cardiomyopathy (WRS)", 
...
boxplot(pvalueWithoutNull[Colorectal_cancer], pvalueWithNull[Colorectal_cancer],
        main="pValue(s) of Colorectal cancer (WRS)", 
...
boxplot(pvalueWithoutNull[Prostate_cancer], pvalueWithNull[Prostate_cancer],
        main="pValue(s) of Prostate cancer (WRS)", 
...
boxplot(pvalueWithoutNull[Huntingtons_disease], pvalueWithNull[Huntingtons_disease],
        main="pValue(s) of Huntington's disease (WRS)", 
...
boxplot(pvalueWithoutNull[Acute_myeloid_leukemia], pvalueWithNull[Acute_myeloid_leukemia],
        main="pValue(s) of Acute myeloid leukemia (WRS)", 
...
boxplot(pvalueWithoutNull[Pancreatic_cancer], pvalueWithNull[Pancreatic_cancer],
        main="pValue(s) of Pancreatic cancer (WRS)", 
...
boxplot(pvalueWithoutNull[Non_small_cell_lung_cancer], pvalueWithNull[Non_small_cell_lung_cancer],
        main="pValue(s) of Non-small cell lung cancer (WRS)", 
...
boxplot(pvalueWithoutNull[Parkinsons_disease], pvalueWithNull[Parkinsons_disease],
        main="pValue(s) of Parkinson's disease (WRS)", 
...
boxplot(pvalueWithoutNull[Type_II_diabetes_mellitus], pvalueWithNull[Type_II_diabetes_mellitus],
        main="pValue(s) of Type II diabetes mellitus (WRS)", 
...
boxplot(pvalueWithoutNull[Chronic_myeloid_leukemia], pvalueWithNull[Chronic_myeloid_leukemia],
        main="pValue(s) of Chronic myeloid leukemia (WRS)", 
...
boxplot(pvalueWithoutNull[Endometrial_cancer], pvalueWithNull[Endometrial_cancer],
        main="pValue(s) of Endometrial cancer (WRS)", 
