...
load("/Users/GaMinh/Dropbox/WSU/Papers/PathwayReview/KS_corrected(3rd run).RData")
rankWithNull <- rep(NA, 35)
pvalueWithNull <- rep(NA, 35)

for(i in 1:length(Renal_cell_carcinoma)) {
  rankWithNull[Renal_cell_carcinoma[i]] <- myKSComb_Corrected["Renal cell carcinoma",36+Renal_cell_carcinoma[i]]
  pvalueWithNull[Renal_cell_carcinoma[i]] <- myKSComb_Corrected["Renal cell carcinoma",1+Renal_cell_carcinoma[i]]
}

for(i in 1:length(Alzheimers_disease)) {
  rankWithNull[Alzheimers_disease[i]] <- myKSComb_Corrected["Alzheimer's disease",36+Alzheimers_disease[i]]
  pvalueWithNull[Alzheimers_disease[i]] <- myKSComb_Corrected["Alzheimer's disease",1+Alzheimers_disease[i]]
}


for(i in 1:length(Thyroid_cancer)) {
  
  rankWithNull[Thyroid_cancer[i]] <- myKSComb_Corrected["Thyroid cancer",36+ Thyroid_cancer[i]]
  pvalueWithNull[Thyroid_cancer[i]] <- myKSComb_Corrected["Thyroid cancer",1+Thyroid_cancer[i]]
}

for(i in 1:length(Colorectal_cancer)) {
  #myKSComb_Corrected <- myData[[Colorectal_cancer[i]]]
  rankWithNull[Colorectal_cancer[i]] <- myKSComb_Corrected["Colorectal cancer",36+Colorectal_cancer[i]]
  pvalueWithNull[Colorectal_cancer[i]] <- myKSComb_Corrected["Colorectal cancer",1+Colorectal_cancer[i]]
}

for(i in 1:length(Prostate_cancer)) {
  #myKSComb_Corrected <- myData[[Prostate_cancer[i]]]
  rankWithNull[Prostate_cancer[i]] <- myKSComb_Corrected["Prostate cancer",36+Prostate_cancer[i]]
  pvalueWithNull[Prostate_cancer[i]] <- myKSComb_Corrected["Prostate cancer",1+Prostate_cancer[i]]
}

for(i in 1:length(Acute_myeloid_leukemia)) {
  #myKSComb_Corrected <- myData[[Acute_myeloid_leukemia[i]]]
  rankWithNull[Acute_myeloid_leukemia[i]] <- myKSComb_Corrected["Acute myeloid leukemia",Acute_myeloid_leukemia[i]+36]
  pvalueWithNull[Acute_myeloid_leukemia[i]] <- myKSComb_Corrected["Acute myeloid leukemia",1+Acute_myeloid_leukemia[i]]
}

for(i in 1:length(Pancreatic_cancer)) {
  
  rankWithNull[Pancreatic_cancer[i]] <- myKSComb_Corrected["Pancreatic cancer",36+Pancreatic_cancer[i]]
  pvalueWithNull[Pancreatic_cancer[i]] <- myKSComb_Corrected["Pancreatic cancer",1+Pancreatic_cancer[i]]
}

for(i in 1:length(Non_small_cell_lung_cancer)) {
  
  rankWithNull[Non_small_cell_lung_cancer[i]] <- myKSComb_Corrected["Non-small cell lung cancer",36+Non_small_cell_lung_cancer[i]]
  pvalueWithNull[Non_small_cell_lung_cancer[i]] <- myKSComb_Corrected["Non-small cell lung cancer",1+Non_small_cell_lung_cancer[i]]
}

for(i in 1:length(Glioma)) {
  rankWithNull[Glioma[i]] <- myKSComb_Corrected["Glioma",36+Glioma[i]]
  pvalueWithNull[Glioma[i]] <- myKSComb_Corrected["Glioma",1+Glioma[i]]
}

for(i in 1:length(Parkinsons_disease)) {
  rankWithNull[Parkinsons_disease[i]] <- myKSComb_Corrected["Parkinson's disease",36+Parkinsons_disease[i]]
  pvalueWithNull[Parkinsons_disease[i]] <- myKSComb_Corrected["Parkinson's disease",1+Parkinsons_disease[i]]
}

for(i in 1:length(Chronic_myeloid_leukemia)) {
  rankWithNull[Chronic_myeloid_leukemia[i]] <- myKSComb_Corrected["Chronic myeloid leukemia",36+Chronic_myeloid_leukemia[i]]
  pvalueWithNull[Chronic_myeloid_leukemia[i]] <- myKSComb_Corrected["Chronic myeloid leukemia",1+Chronic_myeloid_leukemia[i]]
}

for(i in 1:length(Type_II_diabetes_mellitus)) {
  rankWithNull[Type_II_diabetes_mellitus[i]] <- myKSComb_Corrected["Type II diabetes mellitus",36+Type_II_diabetes_mellitus[i]]
  pvalueWithNull[Type_II_diabetes_mellitus[i]] <- myKSComb_Corrected["Type II diabetes mellitus",1+Type_II_diabetes_mellitus[i]]
}


for(i in 1:length(Dilated_cardiomyopathy)) {
  rankWithNull[Dilated_cardiomyopathy[i]] <- myKSComb_Corrected["Dilated cardiomyopathy",36+Dilated_cardiomyopathy[i]]
  pvalueWithNull[Dilated_cardiomyopathy[i]] <- myKSComb_Corrected["Dilated cardiomyopathy",1+Dilated_cardiomyopathy[i]]
}


for(i in 1:length(Huntingtons_disease)) {
  rankWithNull[Huntingtons_disease[i]] <- myKSComb_Corrected["Huntington's disease",36+Huntingtons_disease[i]]
  pvalueWithNull[Huntingtons_disease[i]] <- myKSComb_Corrected["Huntington's disease",1+Huntingtons_disease[i]]
}

for(i in 1:length(Endometrial_cancer)) {
  rankWithNull[Endometrial_cancer[i]] <- myKSComb_Corrected["Endometrial cancer",36+Endometrial_cancer[i]]
  pvalueWithNull[Endometrial_cancer[i]] <- myKSComb_Corrected["Endometrial cancer",1+Endometrial_cancer[i]]
}
...
save(TargetPW, dataSets, rankWithoutNull, pvalueWithoutNull, rankWithNull, pvalueWithNull, file = "KSTargetPW.RData")

######################   63 datasets ##############################################

path = "/Users/GaMinh/Dropbox/WSU/Papers/PathwayReview/"
setwd(path)
load("KSTargetPW.RData")
rank = rankWithoutNull
pvalue = pvalueWithoutNull

files= c("alzheimerKS.RData", "AMLKS.RData", "InfluenzaKS.RData")
...
save(rank, pvalue, file = "63Datasets_KS.RData")
...
files= c("alzheimerKS.RData", "AMLKS.RData")
...
save(rank, pvalue, file = "54Datasets_KS.RData")
...
load("/Users/GaMinh/Dropbox/WSU/Papers/PathwayReview/KS15vs15_400_2000(2nd run).RData")

bias0 = vector(mode="numeric", length=nrow(resNullKS))
bias1 = vector(mode="numeric", length=nrow(resNullKS))
names(bias0) = resNullKS$Name
names(bias1) = resNullKS$Name

for (i in 1:nrow(resNullKS)) {
  # print(i)
  x = resNullKS[i,-c(1:3)]
...
save(TargetPW,dataSets, rankBias0, rankWithNullBias0, rankBias1, rankWithNullBias1, rankWithoutNull, rankWithNull,pValueBias0, 
     pValueWithNullBias0,pValueBias1, pValueWithNullBias1,pvalueWithoutNull, pvalueWithNull, file = "KS_bias.RData")
...
bias = vector(mode="numeric", length=nrow(resNullKS))
names(bias) = resNullKS$Name

for (i in 1:nrow(resNullKS)) {
  x = as.numeric(resNullKS[i,-c(1:3)])
  x =  na.omit(x)
  bias[i] = Pearson(x)
}
...
save(bias0List, bias1List, file = "KS_bias.RData")
...
boxplot(rankWithoutNull[Renal_cell_carcinoma], rankWithNull[Renal_cell_carcinoma],
        main="Rank(s) of Renal cell carcinoma (KS)", 
...
boxplot(rankWithoutNull[Alzheimers_disease], rankWithNull[Alzheimers_disease],
        main="Rank(s) of Alzheimer's disease (KS)", 
...
boxplot(rankWithoutNull[Thyroid_cancer], rankWithNull[Thyroid_cancer],
        main="Rank(s) of Thyroid cancer (KS)", 
...
boxplot(rankWithoutNull[Dilated_cardiomyopathy], rankWithNull[Dilated_cardiomyopathy],
        main="Rank(s) of Dilated cardiomyopathy (KS)", 
...
boxplot(rankWithoutNull[Colorectal_cancer], rankWithNull[Colorectal_cancer],
        main="Rank(s) of Colorectal cancer (KS)", 
...
boxplot(rankWithoutNull[Prostate_cancer], rankWithNull[Prostate_cancer],
        main="Rank(s) of Prostate cancer (KS)", 
...
boxplot(rankWithoutNull[Huntingtons_disease], rankWithNull[Huntingtons_disease],
        main="Rank(s) of Huntington's disease (KS)", 
...
boxplot(rankWithoutNull[Acute_myeloid_leukemia], rankWithNull[Acute_myeloid_leukemia],
        main="Rank(s) of Acute myeloid leukemia (KS)", 
...
boxplot(rankWithoutNull[Pancreatic_cancer], rankWithNull[Pancreatic_cancer],
        main="Rank(s) of Pancreatic cancer (KS)", 
...
boxplot(rankWithoutNull[Non_small_cell_lung_cancer], rankWithNull[Non_small_cell_lung_cancer],
        main="Rank(s) of Non-small cell lung cancer (KS)", 
...
boxplot(rankWithoutNull[Parkinsons_disease], rankWithNull[Parkinsons_disease],
        main="Rank(s) of Parkinson's disease (KS)", 
...
boxplot(rankWithoutNull[Type_II_diabetes_mellitus], rankWithNull[Type_II_diabetes_mellitus],
        main="Rank(s) of Type II diabetes mellitus (KS)", 
...
boxplot(rankWithoutNull[Chronic_myeloid_leukemia], rankWithNull[Chronic_myeloid_leukemia],
        main="Rank(s) of Chronic myeloid leukemia (KS)", 
...
boxplot(rankWithoutNull[Endometrial_cancer], rankWithNull[Endometrial_cancer],
        main="Rank(s) of Endometrial cancer (KS)", 
...
boxplot(pvalueWithoutNull[Renal_cell_carcinoma], pvalueWithNull[Renal_cell_carcinoma],
        main="pValue(s) of Renal cell carcinoma (KS)", 
...
boxplot(pvalueWithoutNull[Alzheimers_disease], pvalueWithNull[Alzheimers_disease],
        main="pValue(s) of Alzheimer's disease (KS)", 
...
boxplot(pvalueWithoutNull[Thyroid_cancer], pvalueWithNull[Thyroid_cancer],
        main="pValue(s) of Thyroid cancer (KS)", 
...
boxplot(pvalueWithoutNull[Dilated_cardiomyopathy], pvalueWithNull[Dilated_cardiomyopathy],
        main="pValue(s) of Dilated cardiomyopathy (KS)", 
...
boxplot(pvalueWithoutNull[Colorectal_cancer], pvalueWithNull[Colorectal_cancer],
        main="pValue(s) of Colorectal cancer (KS)", 
...
boxplot(pvalueWithoutNull[Prostate_cancer], pvalueWithNull[Prostate_cancer],
        main="pValue(s) of Prostate cancer (KS)", 
...
boxplot(pvalueWithoutNull[Huntingtons_disease], pvalueWithNull[Huntingtons_disease],
        main="pValue(s) of Huntington's disease (KS)", 
...
boxplot(pvalueWithoutNull[Acute_myeloid_leukemia], pvalueWithNull[Acute_myeloid_leukemia],
        main="pValue(s) of Acute myeloid leukemia (KS)", 
...
boxplot(pvalueWithoutNull[Pancreatic_cancer], pvalueWithNull[Pancreatic_cancer],
        main="pValue(s) of Pancreatic cancer (KS)", 
...
boxplot(pvalueWithoutNull[Non_small_cell_lung_cancer], pvalueWithNull[Non_small_cell_lung_cancer],
        main="pValue(s) of Non-small cell lung cancer (KS)", 
...
boxplot(pvalueWithoutNull[Parkinsons_disease], pvalueWithNull[Parkinsons_disease],
        main="pValue(s) of Parkinson's disease (KS)", 
...
boxplot(pvalueWithoutNull[Type_II_diabetes_mellitus], pvalueWithNull[Type_II_diabetes_mellitus],
        main="pValue(s) of Type II diabetes mellitus (KS)", 
...
boxplot(pvalueWithoutNull[Chronic_myeloid_leukemia], pvalueWithNull[Chronic_myeloid_leukemia],
        main="pValue(s) of Chronic myeloid leukemia (KS)", 
...
boxplot(pvalueWithoutNull[Endometrial_cancer], pvalueWithNull[Endometrial_cancer],
        main="pValue(s) of Endometrial cancer (KS)", 
